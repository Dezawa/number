...
class Numpre7
  ...
  def url_base ; 'https://numpre7.com' ; end
  def game_url ; "#{url_base}/np#{game_number}" ; end
  def output_file(number) ; "np#{number}" ; end
  def game_number_level(lvl) ;  "game_number_level#{lvl}" ; end
