...
def try(grps)
  [0, 1, 2, 3].each do |i|
    $gsw = true
    while $gsw
      $gout ? puts 'while loop top'; grps.gout : nil
      $gsw = nil
      grps.highClass.each do |method|
        # puts method.inspect
        sw = true
        while sw
          sw = nil
          ...
          $gout ? puts 'rest one end'; grps.gout : nil
          ...
          (2..4).each do |vnum|
            ...
            $gout ? puts "teiin #{vnum} end"; grps.gout : nil
          end
          $gout && grps.gout
